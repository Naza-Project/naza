...
public:
	using after_handler = std::function<void()>;
...
public:
	using RW_handler = std::function<void(bool can_read, bool can_write)>;
	using D_handler = std::function<void(void)>;
...
public:
	using A_handler = std::function<void()>;
