...
namespace nazacoin {
	...
	public:
		...
		using D_handler = std::function<void(std::string ban_reason)>;
	...
	class P2P {
	public:
		using client_factory = std::function<std::unique_ptr<P2PClient>(bool incoming, P2PClient::D_handler d_handler)>;
